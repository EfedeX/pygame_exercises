...
GRAY = (240, 240, 240)
BLACK = (0, 0, 0)
BLACK_MEDIUM = (40, 40, 40)
GRAY_ALPHA = (60, 60, 60, 255)
WHITE = (255, 255, 255)
RED = (255, 0, 0)
GREEN = (0, 255, 0)
BLUE = (0, 0, 255)
...
while True:
    ...
    pygame.draw.circle(window, GRAY_ALPHA, (WINDOW_WIDTH/2 + 10, WINDOW_HEIGHT/2 + 10), 50, 0) 
    pygame.draw.circle(window, BLACK_MEDIUM, (WINDOW_WIDTH/2, WINDOW_HEIGHT/2), 50, 0)
